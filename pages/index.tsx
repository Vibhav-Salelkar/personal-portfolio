...
const index = () => {  
  return (
    <div className="flex flex-col flex-grow px-6 pt-1">
      ...
      <div className="flex-grow p-4 mt-6 bg-vspanel dark:bg-dark-100" style={{marginLeft: '-1.5rem', marginRight: '-1.5rem'}}>
        <h6 className="mt-4 mb-6 text-xl font-bold tracking-wide">What I Offer</h6>
        <div className="grid gap-6 lg:grid-cols-2">
          {skills.map((skill) => {
            return <div className="bg-gray-200 rounded-lg dark:bg-dark-200 lg:col-span-1">
