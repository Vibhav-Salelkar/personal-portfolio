...
export const projects: IProject[] = [
  ...
  },
  {
    ...
    desc: "MERN Stack app where user can create account, post memories, like, comment on others post. Also added features like authentication, middlewares, pagination, related posts and many more.",
    img: "mern-stack.png",
    source: "https://socialmemories.netlify.app/",
